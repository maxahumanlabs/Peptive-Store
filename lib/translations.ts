export const translations = {
  en: {
    ...
    cart: {
      ...
      proceed_to_checkout: "Order via WhatsApp",
      view_cart: "View Cart",
      remove: "Remove",
      add: "Add",
  ...
  ar: {
      ...
      questions: [
        {
          ...
          answer: "يمكنك شراء ببتيدات الأبحاث مباشرة من ببتيدات Peptive. نحن نقدم ببتيدات عالية الجودة تم التحقق منها من قبل المختبر ويتم شحنها مباشرة من منشأتنا السويسرية إلى موقعك."
        },
        {
        ...
        },
        {
          ...
          answer: "ابحث عن الموردين الذين يقدمون اختبارات معملية من طرف ثالث ومصادر شفافة ومعلومات مفصلة عن المنتج. في ببتيدات Peptive، نحن نقدم التحقق المستقل من المختبر لجميع منتجاتنا."
        },
        {
    ...
    product_detail: {
      ...
      hurry_only: "أسرع، تبقّى فقط",
      hurry_offer_ends: "بسرعة، ينتهي العرض خلال ",
      items_left: "عبوات في المخزون!",
      delivered_stats: "١٥,٠٠٠+ طرد تم تسليمه عالمياً",
      order_whatsapp: "اطلب عبر واتساب + شحن مجاني + خصم 10%",
      more_results: "قد يعجبك أيضاً إضافته لنتائج أفضل",
      view_all: "عرض الكل",
    ...
    footer: {
      ...
      join: "انضم إلى مستقبل علم الأحياء واحصل على خصم 15% + نسخة مجانية من 'دليل الببتيدات Peptive' الخاص بنا.",
    ...
    cart: {
      ...
      proceed_to_checkout: "اطلب عبر واتساب",
      view_cart: "عرض السلة",
      remove: "إزالة",
      add: "أضف",
    ...
    bundle: {
      ...
      tag_two_months: "الأكـثـر طـلـباً",
